...
type Handler interface {
	...
	AddData(ctx context.Context, req []GpsData, params AddDataParams) (AddDataRes, error)
	...
	AddTrips(ctx context.Context, req []Trip, params AddTripsParams) (AddTripsRes, error)
	...
	CreateShipment(ctx context.Context, req *ExternalCreateShipmentRequest) (CreateShipmentRes, error)
	...
	//
	// POST /v1/auth/token
	GetToken(ctx context.Context, req *TokenRequest) (GetTokenRes, error)
	...
	RequestQuote(ctx context.Context, req *ExternalRequestQuoteRequest) (RequestQuoteRes, error)
